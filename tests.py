...
class TestBasicClient(unittest.TestCase):
    def test_tickers_property(self):
        client = basicClient()
        client.tickers = [{"name": "Bitcoin", "symbol": "BTC"}, {"name": "Apple", "symbol": "AAPL"}]
        self.assertEqual(client.tickers, [{"name": "Apple", "symbol": "AAPL"}, {"name": "Bitcoin", "symbol": "BTC"}])
    ...
    def test_get_tickets(self):
        ...
        self.assertEqual(client.getTickets(tickets), [client.getTicket("AAPL")])
